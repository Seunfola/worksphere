...
const TalentForgotPassword: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Talent Forgot Password submitted:', formData);
  };

  return (
    <section className="py-16 bg-gray-100">
      <div className="container mx-auto text-center">
        <h2 className="text-3xl font-semibold text-primary mb-8">Talent Forgot Password</h2>
...
export default TalentForgotPassword;
