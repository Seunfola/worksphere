      ...
      <div className="bg-white shadow-md py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-3/4 text-gray-800">
              <section id="relationship" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">1. Your Relationship with WorkConnect</h2>
                <p>
                ...
                <p>Your legal agreement with WorkConnect is made up of the following documents:</p>
              ...
              <section id="accepting-terms" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">2. Accepting the Terms</h2>
                <p>
                ...
                <p>You must be at least 16 years old to use the Service. By using the Service, you represent and warrant that you meet this age requirement.</p>
              </section>

              <section id="changes-terms" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">3. Changes to the Terms</h2>
                <p>
              ...
              <section id="accounts" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">4. WorkConnect Accounts</h2>
                <p>
              ...
              <section id="restrictions" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">5. General Restrictions on Use</h2>
                <p>
              ...
              <section id="content-policy" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">6. Content Policy</h2>
                <p>
                ...
                <p>WorkConnect reserves the right to review, flag, and remove content that violates these Terms or that we deem inappropriate for the Service.</p>
              </section>

              <section id="rights" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">7. Rights You Grant Us</h2>
                <p>
              ...
              <section id="job-listings" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">8. Job Listings and Freelance Projects</h2>
                <p>
              ...
              <section id="ending-relationship" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">9. Ending Your Relationship with WorkConnect</h2>
                <p>
              ...
              <section id="liability" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">10. Limitation of Liability</h2>
                <p>
                ...
                <p>In no event shall WorkConnect be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from:</p>
                <ul className="list-disc ml-5 mt-2">
              ...
              <section id="warranties" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">11. Exclusion of Warranties</h2>
                <p>
              ...
              <section id="legal-terms" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">12. General Legal Terms</h2>
                <p>
                  These Terms shall be governed by and construed in accordance with the laws of [Your Jurisdiction], without regard to its conflict of law provisions.
                </p>
                <p>These Terms constitute the entire agreement between you and WorkConnect concerning the Service.</p>
                ...
                <p>WorkConnect's failure to enforce any right or provision of these Terms will not be considered a waiver of those rights.</p>
              </section>

              <section id="contact" className="mb-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4">13. Contact Information</h2>
                ...
                <ul className="list-none mt-2">
                  ...
                  <li>Phone: +1(339) 746-3369</li>
                </ul>
              </section>

              <div className="flex justify-center lg:justify-start mt-8">
                <button className="px-4 py-2 text-white bg-orange-500 rounded-md hover:bg-orange-600 focus:outline-none">Decline</button>
